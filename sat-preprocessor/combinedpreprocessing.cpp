...
namespace combined {
    ...
    std::map<int, int> combined::creat_mapping(CDNF_formula &formula) {
        std::map<int, int> map;
    ...
    void combined::pureLiteralElimination(CDNF_formula &formula, std::map<int, int> &mapping) {
    ...
    void combined::unit_propagation(CDNF_formula &cnf, std::map<int, int> &mapping) {
    ...
    void combined::combined_methode(CDNF_formula& cnf, int timeLimitInSeconds){
